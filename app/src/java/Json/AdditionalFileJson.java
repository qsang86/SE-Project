...
/**
 * Upload additional files and prints output in JSON format
 *
 * @author Daryln
 */
@WebServlet(name = "AdditionalFileJson", urlPatterns = {"/json/update"})
@MultipartConfig
public class AdditionalFileJson extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ArrayList<BootstrapStat> results = UploadCtrl.uploadAdditionalFiles(filePart);
                if (results != null) {
                    ...
                    for (BootstrapError uploadError : allErrors) {
                        ...
                        jsonError.addProperty("message", errorMsg.toString());
